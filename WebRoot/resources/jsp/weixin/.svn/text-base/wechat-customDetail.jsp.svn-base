...
<html>
	<head>
        ...
        (function(l){
            ...
            //
            seajs.use("<%=basePath%>resources/weixin/js_cmd/customDetail.js");
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td width="28%" align="right" valign="top">
					     <s:if test="#request.customer.effectType == 0 ||">
					         <input id="sub_jy" type="button" value="申请结佣" class="btn_khx_02" disabled="disabled"/>  
					     </s:if>
					     <s:else>
					          <s:if test="#request.customer.moneyStatus == 1 && #request.customer.houseInfo.brokerage != null &&  #request.customer.houseInfo.brokerage > 0">
					             <input id="sub_jy" type="button" value="申请结佣" class="btn_khx_01" />
					          </s:if>
					          <s:else>
					             <input id="sub_jy" type="button" value="申请结佣" class="btn_khx_02" disabled="disabled"/>
					         </s:else>
				...
				<tr align="left">
					...
					<td colspan="2" rowspan="2" align="right">
					     <s:if test="#request.customer.effectType == 0">
					          <input id="sub_df" type="button" value="申请到访奖" class="btn_khx_02" disabled="disabled"/>
					     </s:if>
					     <s:else>
					         <s:if test="#request.customer.arrivedStatus == 1 && #request.customer.houseInfo.firstReward != null &&  #request.customer.houseInfo.firstReward > 0">
					            <input id="sub_df" type="button" value="申请到访奖" class="btn_khx_01" />
					         </s:if>
					          <s:else>
					            <input id="sub_df" type="button" value="申请到访奖" class="btn_khx_02" disabled="disabled"/>
					          </s:else>
				...
				<tr>
					...
					<td align="right">
					<s:if test="#request.customer.effectType == 0">
					     <input id="sub_dk" type="button" value="申请带看奖" class="btn_khx_02" disabled="disabled"/>
					</s:if>
					<s:else>
					      <s:if test="#request.customer.lookStatus == 1 && #request.customer.houseInfo.viewReward != null &&  #request.customer.houseInfo.viewReward > 0">
					         <input id="sub_dk" type="button" value="申请带看奖" class="btn_khx_01" />
					      </s:if>
					      <s:else>
					          <input id="sub_dk" type="button" value="申请带看奖" class="btn_khx_02" disabled="disabled"/>
					      </s:else>
			...
			<div  class="timebar_tpc">进度跟踪</div>
			   <s:iterator value="#request.customer.records" var="record" status="st">
				...
				<div style="margin-top: 50px;">
				    <s:if test="#request.customer.presStatus == 1">
				         <input class="btn_cb_gray " type="button" value="催办" disabled="disabled" style="width: 46%">
				    </s:if>
				    <s:else>
				         <input class="btn_cb_gray" type="button" value="催办" id="btn_cb" style="width: 46%">
				    </s:else>
				    <s:if test="#request.customer.appealStatus == 1">
				         <input class="btn_cb_gray" type="button" value="申诉" disabled="disabled" style="width: 46%">
				    </s:if>
				    <s:else>
				         <input class="btn_cb_gray" type="button" value="申诉" id="btn_ss" style="width: 46%">
				    </s:else>
