		...
		<s:form action="govhonorunit!save" namespace="/admin" method="post" id="base_frm">
			...
			<table id="info" width="95%" border="0" cellspacing="0" cellpadding="0" class="tab_1" style="margin:40px 0 0 40px;float:left;">
			  	...
			  	<tr>
					...
					<td width="84%">
					<!--  
					    <s:if test="#session.userinfo_in_session.unitId != null">
				...
				<tr>
					...
					<td width="84%">
					     <!--<s:if test="#session.userinfo_in_session.cityId != null">
				...
				<tr>
					...
					<td width="84%">
						 <s:textfield  name="honor.honorDuty" cssClass="input_1 input_1_w"></s:textfield>
				    </td>
				</tr>				
