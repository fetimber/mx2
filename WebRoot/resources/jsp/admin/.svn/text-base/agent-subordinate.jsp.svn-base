...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="home">
			<img src="resources/images/icon_home.png" width="20" height="20" />数据管理&nbsp;>&nbsp;下线管理
		</div>
		<div class="m_w">
			<!--检索部分-->
			<div class="tab_check" style="min-width: 850px;">
				<s:form action="agent!subordinate" namespace="/admin" id="base_frm" style="float:left;">
					...
					<s:hidden name="query.signCountMin"></s:hidden>
				</s:form>
