...
//                      }
	...
	<body>
		<div class="home">
			<img src="resources/images/icon_home.png" width="20" height="20" />困难职工库&nbsp;>&nbsp;困难职工管理&nbsp;>&nbsp;发放记录详情
		</div>
		<s:form action="record!save" namespace="/admin" method="post" id="base_frm">
			...
			<table id="info" width="95%" border="0" cellspacing="0" cellpadding="0" class="tab_1" style="margin:40px 0 0 40px;float:left;">
				...
				<tr>
					...
					<td width="84%">
						<input  name="record.sendTime" type="text" class="input_1 input_1_w timer" value="<s:date name="%{record.sendTime}" format="yyyy-MM-dd" />" />&nbsp;&nbsp;<span style="color:red">*</span>
                     </td>
				</tr>
