...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="min-width: 1700px;">
		<div class="home">
			<img src="resources/images/icon_home.png" width="20" height="20" />数据管理&nbsp;>&nbsp;楼盘管理&nbsp;>&nbsp;新增楼盘信息
		</div>
			...
			<table width="50%" border="0" cellspacing="0" cellpadding="0" class="tab_1" style="margin:40px 0 0 40px;float:left;">
				<tr>
					...
					<s:if test="null == project">
						...
						<s:elseif test="null == project.checkPic01">
							<span class="upload_imgs"></span>
						</s:elseif>
						<s:else>
							<s:iterator value="project.smallPictures" var="item">
								<span pic_id="<s:property value="#item.id" />" class="upload_imgs smallpic">
								<a href="javascript:delete_img(2,<s:property value="#item.id" />)" class="img_close"></a>
				...
				<tr>
					...
					<td valign="top" style="padding-top:0;" id="big_imgs">
						...
						<s:elseif test="null == project.bigPictures">
							<span class="upload_imgs_1"></span>
						</s:elseif>
						<s:else>
				...
				<tr>
					...
					<td width="84%" > 
						<input type="button"  value="上传图片" class="btn_upload" />&nbsp;&nbsp;&nbsp;&nbsp;<span class="gray">建议大图片尺寸 133像素 X 120像素</span>
					</td>
				</tr>
				<tr>
					<td  align="right">
					...
					<td valign="top" style="padding-top:0;" id="price_imgs">
						...
						<s:else>
							...
							<a href="javascript:delete_img(true,<s:property value="project.priceImageId" />)" class="img_close"></a>
