		...
		<s:form action="govworker!save_poor" namespace="/admin" method="post" id="base_frm">
			...
			<table width="60%" border="0" cellspacing="0" cellpadding="0" class="tab_1" style="margin:40px 0 0 40px;float:left;">
				...
				<tr>
					...
					<td>
					   <s:textfield name="worker.bankCard" cssClass="input_1 input_1_w validate[required,minSize[10],maxSize[20]]"></s:textfield>&nbsp;&nbsp;<span style="color:red">*</span>
					</td>
				</tr>
...
<!-- 				</tr> -->
		       ...
		       <tr>
				...
				<tr>
					...
					<td>
						<input name="workerPoor.sendTime" type="text" class="input_1 input_1_w timer" value="<s:date name="%{workerPoor.sendTime}" format="yyyy-MM-dd" />" />&nbsp;&nbsp;<span style="color:red">*</span>
                     </td>		
				</tr>
